...
![](tf-faster-rcnn/data/imgs/figure.png)      |  ![]( tf-faster-rcnn/data/imgs/figure_2.png )
:-------------------------:|:-------------------------:
Detection results in VEDAI |  Precision-Recal curve of each class


![]( tf-faster-rcnn/data/imgs/figure_21.png )      |  ![]( tf-faster-rcnn/data/imgs/figure_34.png )
:-------------------------:|:-------------------------:
